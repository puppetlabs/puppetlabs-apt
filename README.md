...
* `update_tries`: How many times to attempt running `apt-get update`. Use this to work around transient DNS and HTTP errors. By default, the command only runs once.
